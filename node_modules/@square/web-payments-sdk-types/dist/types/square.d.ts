...
interface Square {
    ...
    /**
     * Copy of the V1 WebSDK payments method, used for backward compatibility
     * when combined with V2 WebSDK.
     * @param applicationId The Application ID used by payments()
     * @param locationId The Location ID used by payments()
     * @private
     */
    _buildWebSDKV1Payments?(applicationId: string, locationId?: string): Payments;
}
export { Square };
