/**
 * See Afterpay/Clearpay's [Options for Afterpay/Clearpay Button](https://developers.afterpay.com/afterpay-online/reference/adding-afterpay-to-your-site#options-for-the-afterpay-button) dcoumentation.
 */
import { LineItem, ShippingErrors, ShippingOption, TokenError, TokenResult } from '../payment-method-types';
import { ShippingContact } from '../../contact';
declare enum AfterpayButtonColor {
    /** Black background */
    BLACK = "black",
    /**
     * @deprecated Mint background
     * @hidden
     */
    GREEN = "mint",
    /** Mint background */
...
type AfterpayButtonColorValues = `${AfterpayButtonColor}`;
/**
 * See Afterpay/Clearpay's [Options for Afterpay/Clearpay Button](https://developers.afterpay.com/afterpay-online/reference/adding-afterpay-to-your-site#options-for-the-afterpay-button) dcoumentation.
 */
declare enum AfterpayButtonType {
...
type AfterpayButtonTypeValues = `${AfterpayButtonType}`;
/**
 ...
 */
declare enum AfterpayFinalCtaButtonType {
    REVIEW_MY_ORDER = "review_my_order",
    BUY_NOW = "buy_now"
}
type AfterpayFinalCtaButtonTypeValues = `${AfterpayFinalCtaButtonType}`;
/**
 * Options for attaching the Afterpay/Clearpay payment method.
 * See Afterpay/Clearpay's [Options for Afterpay Button](https://developers.afterpay.com/afterpay-online/reference/adding-afterpay-to-your-site#options-for-the-afterpay-button) dcoumentation.
 */
interface AfterpayButtonOptions {
 ...
 */
declare enum AfterpayBadgeTheme {
    BLACK_ON_MINT = "black-on-mint",
    BLACK_ON_WHITE = "black-on-white",
    MINT_ON_BLACK = "mint-on-black",
    WHITE_ON_BLACK = "white-on-black"
}
type AfterpayBadgeThemeValues = `${AfterpayBadgeTheme}`;
declare enum AfterpaySize {
    XS = "xs",
    SM = "sm",
    MD = "md",
    LG = "lg"
}
type AfterpaySizeValues = `${AfterpaySize}`;
/**
 ...
 */
declare enum AfterpayModalLinkStyle {
...
type AfterpayModalLinkStyleValues = `${AfterpayModalLinkStyle}`;
/**
 ...
 */
declare enum AfterpayModalTheme {
    MINT = "mint",
    WHITE = "white"
}
type AfterpayModalThemeValues = `${AfterpayModalTheme}`;
/**
 ...
 */
interface AfterpayMessagingOptions {
 ...
 * See Afterpay/Clearpay's [Modal Themes](https://developers.afterpay.com/afterpay-online/docs/style-installment-messaging#modal-themes) documentation.
 */
interface AfterpayDisplayInformationModalOptions {
    modalTheme?: AfterpayModalThemeValues;
}
/**
 * Options for the Checkout Widget to better customize it.
 */
interface AfterpayCheckoutWidgetOptions {
    includeBranding: boolean;
}
/**
 * Callback which is executed upon a buyer completing the Afterpay/Clearpay flow, or an error occuring during the Afterpay/Clearpay flow.
 */
type TokenizationCallback = (result?: TokenResult, error?: TokenError) => void;
declare enum AfterpayEvents {
    /**
...
type AfterpayEventsValue = `${AfterpayEvents}`;
interface AfterpayShippingOption extends ShippingOption {
 ...
 */
interface AfterpayPaymentRequestShippingUpdate {
    error?: string;
 ...
 */
type AfterpayShippingContactCallback = (contact: ShippingContact) => AfterpayPaymentRequestShippingUpdate | Promise<AfterpayPaymentRequestShippingUpdate>;
/**
 ...
 */
type AfterpayShippingOptionCallback = (option: ShippingOption) => void;
type AfterpayPaymentRequestCallback = AfterpayShippingContactCallback | AfterpayShippingOptionCallback;
type AfterpayPaymentRequestUpdater = (update: AfterpayPaymentRequestShippingUpdate) => void;
export { AfterpayButtonColor, AfterpayButtonColorValues, AfterpayButtonOptions, AfterpayButtonType, AfterpayFinalCtaButtonType, AfterpayCheckoutWidgetOptions, AfterpayMessagingOptions, AfterpayPaymentRequestCallback, AfterpayShippingContactCallback, AfterpayShippingOptionCallback, AfterpayPaymentRequestShippingUpdate, AfterpayPaymentRequestUpdater, AfterpayEvents, AfterpayEventsValue, TokenizationCallback, AfterpayShippingOption, AfterpayDisplayInformationModalOptions, AfterpayModalTheme, AfterpayModalLinkStyle, AfterpaySize, AfterpayBadgeTheme, AfterpayBadgeThemeValues, AfterpayModalLinkStyleValues, AfterpayModalThemeValues, AfterpaySizeValues, };
