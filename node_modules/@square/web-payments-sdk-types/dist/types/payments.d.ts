import { AchOptions, AfterpayClearpay, CashApp, CashAppPay, CashAppPaymentRequestOptions, DigitalWalletOptions, PaymentRequestOptions } from './payment-method';
...
interface Payments {
     ...
     * @param options
     * @throws {MethodNotAvailableError} the feature flag for this method was not enabled
     ...
     * @throws {InvalidPaymentRequestError} the provided payment request was invalid
     * @throws {UnexpectedError} if the payment context cannot initialize
     * @throws {ScriptLoaderError} if the CashAppPay script cannot be loaded
     */
